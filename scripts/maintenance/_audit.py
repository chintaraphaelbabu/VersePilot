...
fr = json.load(open('outputs/replay/failure_report.json','r',encoding='utf-8'))
...
for sid in range(1,14):
    try:
        t = json.load(open(f'outputs/replay/{sid}/timings.json','r',encoding='utf-8'))
...
for sid in range(1,14):
    try:
        refs = json.load(open(f'outputs/replay/{sid}/detected_references.json','r',encoding='utf-8'))
